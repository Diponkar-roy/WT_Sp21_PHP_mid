		...
		<form action="" method="post">
			<table>
				...
				<tr>
					...
					<td>:<input type="checkbox" value="<?php echo $hobbies;?>" name="Hobbies[]">Music 
					     <input type="checkbox" value="<?php echo $Hobbies;?>" name="Hobbies[]">Movies  
						 <input type="checkbox" value="<?php echo $Hobbies;?>" name="Hobbies[]">Games
						 <input type="checkbox" value="<?php echo $Hobbies;?>" name="Hobbies[]">Danching
